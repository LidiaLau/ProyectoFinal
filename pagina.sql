CREATE DATABASE  IF NOT EXISTS `pagina` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pagina`;
...
CREATE TABLE `perdido` (
  `IdPerdido` int(11) NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(45) NOT NULL,
  `Email` varchar(45) NOT NULL,
  `Celular` varchar(10) NOT NULL,
  `NombreMascota` varchar(45) NOT NULL,
  `Sena` varchar(45) NOT NULL,
  PRIMARY KEY (`IdPerdido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `perdido`
--

LOCK TABLES `perdido` WRITE;
...
-- Dump completed on 2017-06-07 14:30:20
